...
from space_tracer.module_importers import PatchedModuleFinder, \
    TracedModuleImporter
...
if IS_PYODIDE:
    ...
    Canvas = MockTurtle = MockPyglet = None
else:
    from .canvas import Canvas
    from .mock_turtle import MockTurtle
    from .report_builder import ReportBuilder
    from .module_importers import builtins, imp
