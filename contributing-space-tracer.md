...
1. Before building the package, update the Emacs download count, as described in
   `contributing-emacs.md`.
2. Update the version number in `about.py` and development status in
   `pyproject.toml`.
3. Activate the latest Python's virtual environment.
...
8. Remove the uploaded files and recreate the tox environment. (The browser
